...
| **3.2** | **Đánh giá Thực nghiệm Đa chiều (5D-EF)**<br>- Chạy Ablation Study (so sánh 6 cấu hình A-F) trên 4,267 mẫu GT.<br>- Đánh giá tính chịu lỗi trước 120 mẫu Adversarial (6 loại).<br>- Đo đạc độ trễ (Latency baseline), kiểm định Mann-Whitney U.<br>- Chạy kiểm định LLM-as-Judge chéo họ mô hình. | 22/07 – 02/08 | - Báo cáo thực nghiệm tự động ghi nhận trên **MLflow**.<br>- Biểu đồ phân tích độ trễ và F1-Score cho luận văn. | ⏳ |
