...
Based on the objectives, this thesis focuses on three core research questions:
...
2. Can a Delimited Data Encapsulation mechanism (using Dynamic Randomized Delimiters), reinforced by a deterministic Tier-1/Tier-2 consensus guard and a Human-in-the-Loop quarantine, prevent structural Prompt Injections (e.g., Delimiter Smuggling) and unsafe autonomous responses without degrading the LLM's classification accuracy?
