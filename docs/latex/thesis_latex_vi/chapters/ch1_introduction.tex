...
Sự tăng tốc của chuyển đổi số toàn cầu, đặc trưng bởi sự phổ biến của các mô hình điện toán đám mây nguyên bản (cloud-native), Internet Vạn vật (IoT) và hạ tầng làm việc từ xa phi tập trung, đã làm xói mòn về cơ bản các vành đai mạng truyền thống. Do đó, mạng doanh nghiệp đã chuyển đổi thành các môi trường có độ rỗng cao, không đồng nhất, mở rộng theo cấp số nhân bề mặt tấn công tiềm năng cho các tác nhân độc hại. Trong hệ sinh thái đầy biến động này, các đối thủ mạng liên tục tinh chỉnh phương pháp luận của chúng, chuyển từ các chủng phần mềm độc hại biệt lập, dễ nhận biết sang các chiến dịch tinh vi, được dàn dựng khéo léo được gọi là Cuộc tấn công Có chủ đích (APT) \cite{ids2018}. Những tác nhân đe dọa tinh vi này tận dụng các tải trọng đa hình (polymorphic payloads), các kỹ thuật "living-off-the-land" (LotL) và các kênh chỉ huy và kiểm soát (C2) được mã hóa để làm xáo trộn các hoạt động của chúng, cho phép chúng xâm nhập và di chuyển trong mạng doanh nghiệp mà không bị phát hiện trong thời gian dài.

Trung tâm Điều hành An ninh mạng (SOC) đóng vai trò là cơ chế phòng thủ quan trọng cho các tổ chức, được giao nhiệm vụ giám sát liên tục, phát hiện theo thời gian thực và giảm thiểu nhanh chóng các sự cố bảo mật. Để đạt được điều này, các SOC hiện đại triển khai vô số cảm biến đo lường từ xa về bảo mật, bao gồm Tường lửa Thế hệ Tiếp theo (NGFW), Hệ thống Phát hiện và Ngăn ngừa Xâm nhập (IDS/IPS) và các tác tử Phát hiện và Phản hồi Điểm cuối (EDR). Các luồng dữ liệu đa dạng này thường được tập hợp vào một nền tảng Quản lý Thông tin và Sự kiện Bảo mật (SIEM) trung tâm. Tuy nhiên, việc liên tục tiếp nhận luồng dữ liệu đo lường từ xa này đã xúc tác cho một cuộc khủng hoảng cấu trúc trong ngành công nghiệp an ninh mạng, thường được gọi là "Nghịch lý Dữ liệu Lớn" (Big Data Paradox). Nghịch lý này biểu hiện qua một số lỗ hổng hoạt động nghiêm trọng:
