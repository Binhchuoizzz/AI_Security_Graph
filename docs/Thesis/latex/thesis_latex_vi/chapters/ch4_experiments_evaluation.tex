...
Cổng tự quyết $83.8\%$ ca leo thang ở $0.35$\,ms với precision $98.82\%$, nên chỉ $\approx\!16\%$ còn lại chạm tới tầng nhận thức nhiều giây. Đây là đóng góp hiệu suất cốt lõi: nó biến một hệ vốn phải đẩy mọi ca mơ hồ lên LLM thành một hệ trong đó mô hình ngôn ngữ là tài nguyên khan hiếm, được dành riêng. Dưới nhiễu đối kháng trên đặc trưng (cực đoan đơn/đa đặc trưng), cổng giữ lại $99.58\%$ phán quyết tấn công đúng, xác nhận biên học không sụp đổ khi gặp đầu vào lệch phân bố.
