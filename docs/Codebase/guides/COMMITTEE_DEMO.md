...
> (Tier-1 Filter/Welford → Tier-2: Cổng ML → LLM cục bộ → HITL → Dashboard). Không cần chạy 4
...
>
> **Thông điệp cốt lõi (1 câu):** *Tier-1 lọc rẻ (O(1)) phần lớn lưu lượng; Tier-2 hai chặng: Cổng ML phân loại nhanh (early-exit), chỉ ca phức tạp mới tới LLM cục bộ air-gapped — **giảm 82.97% độ trễ** (đo trên dataset trước 2026-07-16 — cần đo lại sau khi đổi ground_truth) mà vẫn phát hiện APT đa ngày, zero-day
