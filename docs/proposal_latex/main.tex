...
The recent emergence of Large Language Models (LLMs) has opened new directions for automated log summarization and incident response. Comprehensive surveys \citep{habibzadeh2025} and studies such as those by \citet{oniagbi2024} demonstrate the use of cloud-based APIs (e.g., GPT-4) for SOC automation. However, relying on cloud APIs violates strict organizational data privacy policies and introduces unacceptable network latency for real-time triage.
