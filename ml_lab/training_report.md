...
- **Tier 2 — Cổng ML (Mục tiêu của Lab này)**: Chặng đầu của Tier-2, dùng mô hình Machine Learning siêu nhẹ (như LightGBM, Decision Tree) làm bộ lọc Early Exit. Nhiệm vụ là chặn đứng ngay lập tức các cuộc tấn công DDoS/Brute-force rõ ràng (đã biết), tiết kiệm chi phí gọi API LLM.
