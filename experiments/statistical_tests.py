...
def run_tests():
    ...
    print("\n--- PERFORMANCE METRICS ---")
    print(f"Config A (Rule-only): F1 = {metrics_A['f1']:.4f} | Prec = {metrics_A['precision']:.4f} | Rec = {metrics_A['recall']:.4f}")
    print(f"Config F (Full Sent): F1 = {metrics_F['f1']:.4f} | Prec = {metrics_F['precision']:.4f} | Rec = {metrics_F['recall']:.4f}")
