...
ROBUSTNESS_RESULTS_PATH = os.path.join(os.path.dirname(__file__), "robustness_results.json")
...
def plot_robustness():
    ...
    bars = plt.bar(categories, defeat_pcts, color=['#ff9999','#66b3ff','#99ff99','#ffcc99'][:len(categories)])
    plt.ylim(0, 110)
    ...
    plt.pie([acc, err], labels=['Accurate', 'Missed/Bypassed'], autopct='%1.1f%%', startangle=90, colors=['#4CAF50', '#F44336'])
